                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{ $member_count }}</div>
                                    <div>Team / Member</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Blog dan News Matahari.CO
                        </div>
                        <!-- /.panel-heading -->
                                            ...
                                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeU">
                                                        ...
                                                        <td>{{ Str::limit($blogss->deskripsi_blog, 50) }}</td>
                                                        <td class="center">
                                                            <img src="{{ asset('images/' . $blogss->img_blog) }}" style="width: 100px; height: 50px;">
                                                        </td>
                                                        <td class="center">
                                                            <a href="{{ url('home/blog/edit/' . $blogss->id_blog) }}" type="button" class="btn btn-success">Edit</a>
